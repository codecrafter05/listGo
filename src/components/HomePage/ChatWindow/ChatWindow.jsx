...
export default function ChatWindow({isDetailsVisible, setIsDetailsVisible}) {
    ...
    return (
        ...
        <div className="col-lg-7 message-view task-view task-left-sidebar">
            <div className="chat-window">
                ...
                <TasksContents selectedListId={selectedListId} isDetailsVisible={isDetailsVisible} setIsDetailsVisible={setIsDetailsVisible} />
            </div>
        </div>
        </>
    );
